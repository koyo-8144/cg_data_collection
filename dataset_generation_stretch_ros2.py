...
def main(cfg : DictConfig):
    ...
    try:
        ...
        frame_idx = 0
        frame_save_interval = 300  # Save every 300 frames
        frame_save_count = 0
        frame_save_num = 100      # Total number of frames to save
        ...
        while True:
            ...
            if frame_idx % frame_save_interval == 0:
                print(f"Collecting frame {frame_idx}...")
                # Get the frame data
            ...
            if frame_save_count == frame_save_num:
                print(f"Reached target frame count ({frame_save_num}).")
                break 
